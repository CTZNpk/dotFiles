...
if [[ $# -eq 1 ]]; then
    ...
    selected=$(find ~/Documents/flutterApps/ ~/Documents/ ~/ ~/Documents/fastApi/ -mindepth 1 -maxdepth 1 -type d | fzf)
fi
...
# Created by `pipx` on 2024-03-02 01:36:37
export PATH="$PATH:/home/haider/.local/bin"
